...
$lErrorFile        = "Could not find or open the dbfile. Make sure you uploaded db dir.";
$lErrorDB	   = "Could not connect to database.  Check your settings again.";
$lErrorTables      = "The database-server couldn't create the tables. It's an upgrade, perhaps?";
