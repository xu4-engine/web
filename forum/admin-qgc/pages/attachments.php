...
<tr>
  <th valign="middle">Show Attachments:</th>
  <td valign="middle"><select name="new_ShowAttachments" size="1"><option value="0" <?php if($ShowAttachments==0) echo "selected"; ?>>As Links</option><option value="1" <?php if($ShowAttachments==1) echo "selected"; ?>>Inline After Message</option></select></td>
</tr>
</table>
<br />
