...
<tr>
    <td nowrap width="50%" align="left" valign="middle"><a href="<?php echo $myname."?page=useradmin&subaction=adduser&sort=$sort&st=$st";?>">Add User</a><br />showing <?php echo $users_found; ?> of <?php echo $total_users; ?> total users</td>
