...
<div class="menu">
  ...
  <span class="menuitem"><a accesskey="2" href="https://sourceforge.net/p/xu4">Sourceforge Project</a></span> |
...
<div class="section">
  <h2>xu4 Development Snapshot Builds</h2>
   <p>No snapshots have been made since the v1.2 release, so download that
   from the links below.</p>
<!--
   <p>These snapshots are generated using recent source code updates.
   Some bugs that were present in previous releases have been fixed in these snapshot builds.
   </p>
...
<div class="section" id="release">
  ...
  <ul>
    <li><a href="https://sourceforge.net/projects/xu4/files/xu4/1.2/xu4-1.2-linux.tar.gz/download">xu4 1.2 for x86_64 Linux</a> <span class="details">(2022-12-06, 8.0 MB, gzipped tar file)</span></li>
    <li><a href="https://sourceforge.net/projects/xu4/files/xu4/1.2/xu4-1.2-win32.zip/download">xu4 1.2 for x86_64 Windows</a> <span class="details">(2022-12-06, 9.7 MB, zip file)</span></li>
    <li><a href="http://sourceforge.net/projects/xu4/files/xu4/1.2/xu4-1.2.tar.gz">xu4 1.2 source code</a> <span class="details">(2022-12-06, 8.0MB, gzipped tar file)</span></li>
