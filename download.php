...
<div class="section">
  ...
  <ul>
    ...
    <li><a href="download/xu4-MacOSX.dmg">xu4 snapshot for Mac OS X</a> <span class="details">(<? $statinfo = stat("download/xu4-MacOSX.dmg"); echo date("M/d G:i T", $statinfo[9]); ?>, Mac OS X version 10.3.9 or later required)</span></li>
  </ul>
</div>
<div class="section">
